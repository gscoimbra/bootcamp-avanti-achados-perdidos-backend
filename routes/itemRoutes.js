...
router.post('/itens', verificarToken, upload.single('foto'), criarItem); // Esta rota aceita formulário com imagem (upload.single('foto'))
router.get('/itens', verificarToken, listarItens);
router.put('/itens/:id', verificarToken, upload.single('foto'), atualizarItem); // Esta rota aceita formulário com imagem (upload.single('foto'))
